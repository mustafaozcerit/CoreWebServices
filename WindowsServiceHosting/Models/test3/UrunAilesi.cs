...
{
    public partial class UrunAilesi
    {
        public UrunAilesi()
        {
            ...
            UrunGrubu = new HashSet<UrunGrubu>();
        ...
        public string EngUrunAilesiAdi { get; set; }
        ...
        public virtual ICollection<UrunGrubu> UrunGrubu { get; set; }
