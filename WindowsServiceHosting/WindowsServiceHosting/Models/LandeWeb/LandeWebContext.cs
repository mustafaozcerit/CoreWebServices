...
{
    public partial class LandeWebContext : DbContext
    {
        public LandeWebContext()
        {
        }

        public LandeWebContext(DbContextOptions<LandeWebContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=176.53.62.195;Database=LandeWeb;User=sa;Password=Mdsf2020@;Trusted_Connection=False;");
            }
        }
